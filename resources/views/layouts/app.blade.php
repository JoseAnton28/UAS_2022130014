    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('teambuilders*') ? 'active' : '' }}"
                            href="{{ route('teambuilders.index') }}">
                            <i class="fas fa-users"></i> Team Builder
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('servants*') ? 'active' : '' }}"
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('craft-essences*') ? 'active' : '' }}"
                            href="{{ route('craftessences.index') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('character-planner*') ? 'active' : '' }}"
                            href="{{ route('character-planner.index') }}">
